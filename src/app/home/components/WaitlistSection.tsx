    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 md:px-6 py-16">
        ...
        <div className="flex items-center gap-3 mb-6 md:mb-8">
          <span className="font-mono text-xs" style={{ color: 'var(--electric)' }}>04 /</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <div>
              ...
              <div className="p-4 md:p-5 min-h-[140px] md:min-h-[160px]">
                {typedLines.map((line, i) => (
                  <div
                    ...
                    style={{
                      color: line.startsWith('$') ? 'var(--electric)'
                        : line.startsWith('>') ? 'var(--chromium-light)'
                        : 'var(--chromium)',
                    }}
                  >
                    {line || '\u00A0'}
                ...
                {typedLines.length < 5 && (
                  <span className="font-mono text-xs animate-blink" style={{ color: 'var(--electric)' }}>▋</span>
                )}
              </div>
            </div>
            ...
            <p className="font-sans text-sm md:text-base leading-relaxed mb-6" style={{ color: 'var(--chromium)' }}>
              Senior Full Stack Developer based in Toronto, ON. Available for full-time roles, contracts, and consulting. Reach out via any channel below.
            </p>
              ...
              {CONTACT_LINKS.map(link => (
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-xs" style={{ color: 'rgba(122,132,144,0.5)' }}>{link.label}</span>
          ...
          <div>
            <div className="terminal-card">
              ...
              <div className="p-5 space-y-0">
                    ...
                    <div className="pb-5 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span
                          ...
                          style={{ color: exp.current ? 'var(--electric)' : 'var(--chromium-light)' }}
                        >
                          {exp.company}
                        </span>
                        {exp.current && (
                      ...
                      <div className="font-mono text-xs mt-0.5" style={{ color: 'rgba(122,132,144,0.4)' }}>
                ...
                >
                  <div className="font-mono text-xs uppercase tracking-widest mb-3" style={{ color: 'rgba(122,132,144,0.4)' }}>
                    Education
                  </div>
                  <div className="font-mono text-xs font-700" style={{ color: 'var(--chromium-light)' }}>
                    Sathyabama University
                  </div>
                  <div className="font-sans text-xs mt-0.5" style={{ color: 'var(--chromium)' }}>
                    B.E. Computer Science Engineering
                  </div>
                  <div className="font-mono text-xs mt-2 px-2 py-1 rounded-sm inline-block" style={{
